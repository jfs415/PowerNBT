...
public class ViewerStyle {
	...
	public ChatColor getColor(String key) {
		...
		if (colorDescription == null) {
			...
			color = ChatColor.of(colorDescription);
		}
	...
	public ChatColor getColorByValue(Object value) {
		if (value == null) {
			return getColor("types.null");
		}
		if (value instanceof Boolean) {
			return getColor("types.bool");
		}
		if (value instanceof Character) {
			return getColor("types.char");
		}
		if (value instanceof Byte) {
			return getColor("types.byte");
		}
		if (value instanceof Short) {
			return getColor("types.short");
		}
		if (value instanceof Integer) {
			return getColor("types.int");
		}
		if (value instanceof Long) {
			return getColor("types.long");
		}
		if (value instanceof Float) {
			return getColor("types.float");
		}
		if (value instanceof Double) {
			return getColor("types.double");
		}
		if (value instanceof String) {
			return getColor("types.string");
		}
		if (value instanceof byte[]) {
			return getColor("types.byte[]");
		}
		...
		if (value instanceof Map) {
			return getColor("types.map");
		}
		if (value instanceof Collection) {
			return getColor("types.list");
		}
