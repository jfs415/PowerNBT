...
public class NBTManagerUtils {
	...
	public static Object[] convertToObjectArrayOrNull(Object someArray) {
		if (someArray instanceof Object[] res) {
			return res;
		}
		if (someArray instanceof boolean[] a) {
			return ArrayUtils.toObject(a);
		}
		if (someArray instanceof byte[] a) {
			return ArrayUtils.toObject(a);
		}
		if (someArray instanceof short[] a) {
			return ArrayUtils.toObject(a);
		}
		if (someArray instanceof int[] a) {
			return ArrayUtils.toObject(a);
		}
		if (someArray instanceof long[] a) {
			return ArrayUtils.toObject(a);
		}
		if (someArray instanceof float[] a) {
			return ArrayUtils.toObject(a);
		}
		if (someArray instanceof double[] a) {
			return ArrayUtils.toObject(a);
		}
		if (someArray instanceof char[] a) {
			return ArrayUtils.toObject(a);
		}
		if (someArray instanceof Collection a) {
			return a.toArray();
		}
		return null;
	}
	...
	public static Object convertToPrimitiveArrayOrNull(Object[] objArray) {
		if (objArray instanceof Boolean[] a) {
			return ArrayUtils.toPrimitive(a);
		}
		if (objArray instanceof Character[] a) {
			return ArrayUtils.toPrimitive(a);
		}
		if (objArray instanceof Byte[] a) {
			return ArrayUtils.toPrimitive(a);
		}
		if (objArray instanceof Short[] a) {
			return ArrayUtils.toPrimitive(a);
		}
		if (objArray instanceof Integer[] a) {
			return ArrayUtils.toPrimitive(a);
		}
		if (objArray instanceof Long[] a) {
			return ArrayUtils.toPrimitive(a);
		}
		if (objArray instanceof Float[] a) {
			return ArrayUtils.toPrimitive(a);
		}
		if (objArray instanceof Double[] a) {
			return ArrayUtils.toPrimitive(a);
		}
		return null;
	}
	...
	public static Object convertToPrimitiveClassType(Class<?> clazz, Object value) {
		if (clazz == Boolean.class || clazz == boolean.class) {
			...
			if (value instanceof Number b) {
				return b.doubleValue() != 0 && !Double.isNaN(b.doubleValue());
			}
			if (value instanceof String b) {
				return !b.isEmpty();
			}
			if (value instanceof Object[] b) {
				return b.length > 0;
			}
			if (value instanceof Collection b) {
				return b.size() > 0;
			}
			if (value instanceof Map b) {
				return b.size() > 0;
			}
	...
	public static Object convertValue(Object value, byte type) {
		return switch (type) {
			case 0 /*end*/ -> null;
			case 1 /*byte*/ -> {
				if (value instanceof Byte current) {
					yield current;
				}
				if (value == null) {
					yield (byte) 0;
				...
				if (value instanceof CharSequence) {
					yield Byte.valueOf(value.toString());
				}
				if (value instanceof Character n) {
					yield (byte) (char) n;
				}
				throw new RuntimeException("Wrong value of type " + type);
			}
			case 2 /*short*/ -> {
				if (value instanceof Short current) {
					yield current;
				}
				if (value == null) {
					yield (short) 0;
				...
				if (value instanceof CharSequence) {
					yield Short.valueOf(value.toString());
				}
				if (value instanceof Character n) {
					yield (short) (char) n;
				}
			...
			case 4 /*long*/ -> {
				if (value instanceof Long current) {
					yield current;
				}
				if (value == null) {
					yield (long) 0;
			...
			case 5 /*float*/ -> {
				if (value instanceof Float current) {
					yield current;
				}
				if (value == null) {
					yield (float) 0;
				...
				if (value instanceof CharSequence) {
					yield Float.valueOf(value.toString());
				}
				if (value instanceof Character n) {
					yield (float) (char) n;
				}
			...
			case 6 /*double*/ -> {
				if (value instanceof Double current) {
					yield current;
				}
				if (value == null) {
					yield (double) 0;
			...
			case 7 /*byte[]*/ -> {
				...
				if (value instanceof CharSequence cs) {
					yield cs.toString().getBytes(StandardCharsets.UTF_8);
				}
				throw new RuntimeException("Wrong value of type " + type);
			}
			case 8 /*String*/ -> {
				...
				if (value instanceof char[] c) {
					yield String.copyValueOf(c);
				}
				if (value instanceof byte[] c) {
					yield new String(c, StandardCharsets.UTF_8);
				}
				throw new RuntimeException("Wrong value of type " + type);
			}
			case 9 /*List*/ -> {
				if (value instanceof CharSequence s) {
					yield Arrays.stream(s.toString().split("")).toList();
				}
				...
				Object[] arr = convertToObjectArrayOrNull(value);
				if (arr != null) {
					yield Arrays.stream(arr).toList();
				}
				throw new RuntimeException("Wrong value of type " + type);
			}
			case 10 /*Compound*/ -> {
			...
			case 11 /*int[]*/ -> {
				if (value instanceof int[] current) {
					yield current;
				}
				if (value == null) {
					yield new int[0];
	...
	static boolean checkCrossReferences(LinkedList<Object> list, Collection<?> values) {
		for (Object value : values) {
			...
			if (value instanceof Collection col) {
				list.push(value);
				if (checkCrossReferences(list, col)) {
					return true;
				}
				list.pop();
			} else if (value instanceof Map map) {
				list.push(value);
				if (checkCrossReferences(list, map.values())) {
					return true;
				}
				list.pop();
			} else if (value instanceof Object[]) {
				list.push(value);
				if (checkCrossReferences(list, Arrays.asList((Object[]) value))) {
					return true;
				}
				list.pop();
			}
